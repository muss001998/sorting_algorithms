 ...
 * @left: reps The starting index of the subset to order.
 * @right: reps the ending index of the subset to order.
 *
...
/**
 * quick_sort - this  Sort an array of integers in ascending
 *              order using the quicksort algorithm.
 * @array:reps An array of integers.
 * @size:reps The size of the array.
 *
